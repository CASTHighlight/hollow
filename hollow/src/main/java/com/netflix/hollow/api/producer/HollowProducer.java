...
public class HollowProducer {
    ...
    private HollowProducer(
        ...
        for (HollowProducerEventListener listener : eventListeners) {
    ...
    private HollowProducer.ReadState restore(
        ...
        Status.RestoreStageBuilder status = listeners.fireProducerRestoreStart(versionDesired);
        try {
            ...
            listeners.fireProducerRestoreComplete(status);
        }
        return readState;
    }
    ...
    public long runCycle(Populator task) {
        ...
        Status.StageWithStateBuilder cycleStatus = listeners.fireCycleStart(toVersion);
    ...
    protected void runCycle(Populator task, Status.StageWithStateBuilder cycleStatus, long toVersion) {
        // 1. Begin a new cycle
